...
public class InstanceTrafficMapper extends PrometheusMeterMapper<InstanceTraffic, Counter> {
	...
	@Override
	public InstanceTraffic prometheusToSkywalking(Model model, Counter metric) {
		try {
