...
public class ServiceInstanceRelationServerSideMetricsMapper extends PrometheusMeterMapper<ServiceInstanceRelationServerSideMetrics, PromeGauge> {
	...
	@Override
	public ServiceInstanceRelationServerSideMetrics prometheusToSkywalking(Model model, List<PromeGauge> metricList) {
		try {
