...
@Deprecated
public class ServiceTrafficMapper extends PrometheusMeterMapper<ServiceTraffic, PromeCounter> {
	...
	@Override
	public ServiceTraffic prometheusToSkywalking(Model model, List<PromeCounter> metricList) {
		try {
