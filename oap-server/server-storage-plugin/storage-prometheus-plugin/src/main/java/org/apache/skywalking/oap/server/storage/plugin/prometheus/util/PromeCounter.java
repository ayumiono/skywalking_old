...
@Getter
public class PromeCounter extends PromeMetric {

	private double value;

    @lombok.Builder
    public PromeCounter(String name, @Singular Map<String, String> labels, double value, long timestamp,int age, String id) {
